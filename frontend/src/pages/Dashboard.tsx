                ...
                <Droppable droppableId={col} key={col}>
                  {(provided) => (
                    <div
                      ...
                      className="bg-white/60 backdrop-blur-xl border border-gray-200 shadow-xl p-4 rounded-3xl w-80 min-w-[320px] flex flex-col max-h-[75vh]"
                    >
                      {/* COLUMN HEADER */}
                      ...
                      {/* CARDS */}
                      <div className="space-y-3 overflow-y-auto overflow-visible pr-1 min-h-[100px]">
                            ...
                            {(provided, snapshot) => {
                              ...
                              const card = (
                                <div
                                  ...
                                  ${
                                    snapshot.isDragging
                                      ? "shadow-2xl scale-105 rotate-1 z-[9999]"
